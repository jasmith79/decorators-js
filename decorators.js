...
(function(root, main) {
  ...
  'use strict';
  var checkJSON, curry, debounce, denodeify, log, onlyIf, runTime, setLocalStorage, throttle, timeoutP, trampoline, unGather, unNew, workerify, _getFnName, _invalidArgumentError, _isArray, _noGlobalCtx;
